...
export default function Art({ expression = "xy+", dynamic = true }) {
  ...
  useEffect(() => {
    ...
    function render(time: number) {
      ...
      if (ctx2) ctx2.drawImage(canvas.current!, 0, 0);
    ...
    >
      <div className="p-3 shadow-lg rounded-lg bg-white">
        <Link href={encodeURIComponent(expression)}>
          <div className="relative mix-blend-hard-light opacity-50 brightness-75">
          ...
          <div className="relative overflow-none">
            <canvas ref={canvas2} width={256} height={256} className="w-64 absolute blur-sm mix-blend-lighten opacity-50" />
          </div>
